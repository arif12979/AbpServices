...
namespace Upwork.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly UpworkDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = UpworkConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(UpworkDbContext context)
        {
            _context = context;
        }
