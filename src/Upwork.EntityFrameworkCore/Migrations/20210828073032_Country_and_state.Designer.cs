...
namespace Upwork.Migrations
{
    ...
    [Migration("20210828073032_Country_and_state")]
    partial class Country_and_state
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Upwork.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Upwork.Entities.State", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("Upwork.Entities.State", b =>
                {
                    b.HasOne("Upwork.Entities.Country", "Country")
                        .WithMany("States")
