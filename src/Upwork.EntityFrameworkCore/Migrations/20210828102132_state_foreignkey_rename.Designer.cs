...
namespace Upwork.Migrations
{
    ...
    [Migration("20210828102132_state_foreignkey_rename")]
    partial class state_foreignkey_rename
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Upwork.Countries.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Upwork.States.State", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Upwork.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Upwork.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Upwork.States.State", b =>
                {
                    b.HasOne("Upwork.Countries.Country", "Country")
                        .WithMany("States")
