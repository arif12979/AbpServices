...
{
    public abstract class UpworkWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static UpworkWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(UpworkWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<UpworkDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<UpworkDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<UpworkDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<UpworkDbContext, Task<T>> func)
        {
            T result;
